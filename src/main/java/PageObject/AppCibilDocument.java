...
public class AppCibilDocument {
	
	AppiumDriver ldriver;
	private WebDriverWait wait;

	public AppCibilDocument(AppiumDriver rdriver)
	{
		ldriver=rdriver;
	...
	@AndroidFindBy(xpath="//android.widget.TextView[@resource-id=\"com.example.app:id/document_head\"]")
	@CacheLookup
	public WebElement applicantCibilUpload;
